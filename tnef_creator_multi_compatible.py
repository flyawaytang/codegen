#!/usr/bin/env python3
# TNEF Creator Multi Compatible - Generate TNEF files with multiple custom embedded filenames
...
def create_tnef_file(output_file, attachments):
    ...
    # Add each attachment as a separate complete TNEF attachment
    for i, attachment in enumerate(attachments):
        ...
        # This is important for compatibility with some TNEF extractors
