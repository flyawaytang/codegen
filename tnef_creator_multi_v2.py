#!/usr/bin/env python3
# TNEF Creator Multi V2 - Generate TNEF files with multiple custom embedded filenames
...
def create_tnef_file(output_file, attachments):
    ...
    for attachment in attachments:
        ...
        transport_filename = filename_bytes  # Use the same filename for transport
